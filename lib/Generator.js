...
//     return fs.writeFile(fileName, generateHTML(data), (error) => {
//         if(error) console.log(error)
//     });
//     // return writeFile(fileName, generateHTML(data));
...
class Generator {
    ...
    //Adds Employees and generates HTML once complete
        ...
        .then (val => {
            switch (val.menu){
                ...
                case "Finish Building Team":
                    ...
                    console.log(teamArr);
                    return fs.writeFile("./dist/index.html", generateHTML(teamArr), (error) => {
                        if(error) console.log(error)
                    });
            }
